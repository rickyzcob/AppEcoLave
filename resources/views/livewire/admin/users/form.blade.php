<div>
    <div class="flex items-center flex-wrap gap-3 justify-between p-4">
        <div class="font-bold text-gray-600">
            <h2 class="text-lg font-medium">{{$user ? "Editar" : 'Cadastrar'}} Usuário</h2>
        </div>
    </div>
    ...
    <form wire:submit="save">
        <div class="grid grid-cols-12 gap-4 p-4 ">
            ...
            <div class="md:col-span-6 col-span-12">
                <x-password  type="password" wire:model="state.password" label="Crie uma senha"/>
                @error('password')
            ...
            <div class="md:col-span-6 col-span-12">
                <x-password  type="password" wire:model="state.password_confirmation" label="Confirme sua senha"/>
            ...
            <div class="md:col-span-12">
                <x-button sm type="submit" text="{{$user ? 'Atualizar' : 'Cadastrar' }}" />
            </div>
        </div>
    </form>
</div>
