...
trait FormDefaultInputClasses
{
    ...
    {
        return [
            'wrapper' => 'focus:ring-primary-600 focus-within:focus:ring-primary-600 focus-within:ring-primary-600 dark:focus-within:ring-primary-600 flex rounded-md ring-1 focus-within:ring-2',
            'base' => 'dark:placeholder-dark-400 w-full rounded-md border-0 bg-transparent pl-2 py-1.5 ring-0 placeholder:text-gray-400 focus:outline-hidden focus:ring-transparent sm:text-sm sm:leading-6',
