...
class Component extends TallStackUiComponent implements Customization
{
    ...
    public function customization(): array
    {
        return Arr::dot([
            'wrapper' => [
                ...
                'fifth' => 'flex flex-col bg-slate-200 shadow-xl dark:bg-dark-700',
                'panel' => [
                    'inset-y' => 'inset-y-0',
                    'bottom' => 'bottom-0',
                    'left' => 'left-0',
            ...
            'header' => [
                'base' => 'px-2',
                'divider' => 'border-b border-b-gray-200 pb-2 dark:border-b-dark-600',
                'layout' => [
    ...
    protected function validate(): void
    {
        ...
        $sizes = ['sm', 'md', 'lg', 'xl', '2xl', '3xl', '4xl', '5xl', '6xl', '7xl', 'full', '720', '700', '680', '600', '580'] ;
