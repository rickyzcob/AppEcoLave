...
class CompileConfigurations
{
    ...
    private static function slide(Slide $component): array
    {
        ...
        $component->size = match ($component->size) {
            ...
            '600' => $component->bottom || $component->top ? 'h-[80rem] sm:max-h-[56rem]' : 'sm:max-w-[650px]',
            '720' => $component->bottom || $component->top ? 'h-[80rem] sm:max-h-[56rem]' : 'sm:max-w-[720px]',
            '700' => $component->bottom || $component->top ? 'h-[80rem] sm:max-h-[56rem]' : 'sm:max-w-[700px]',
            '680' => $component->bottom || $component->top ? 'h-[80rem] sm:max-h-[56rem]' : 'sm:max-w-[680px]',
